...
class InitStorageManagementRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitStorageManagementRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitStorageManagementRequest
    let len;
    let data = new InitStorageManagementRequest(null);
  ...
  static datatype() {
    ...
    return 'auto_smart_factory/InitStorageManagementRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitStorageManagementRequest(null);
...
class InitStorageManagementResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitStorageManagementResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitStorageManagementResponse
    let len;
    let data = new InitStorageManagementResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'auto_smart_factory/InitStorageManagementResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitStorageManagementResponse(null);
...
module.exports = {
  Request: InitStorageManagementRequest,
  Response: InitStorageManagementResponse,
  md5sum() { return '4103325ed00a1108dd334f37449672aa'; },
  datatype() { return 'auto_smart_factory/InitStorageManagement'; }
};
