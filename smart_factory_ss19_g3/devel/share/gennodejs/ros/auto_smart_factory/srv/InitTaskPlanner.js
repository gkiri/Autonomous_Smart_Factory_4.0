...
class InitTaskPlannerRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitTaskPlannerRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitTaskPlannerRequest
    let len;
    let data = new InitTaskPlannerRequest(null);
  ...
  static datatype() {
    ...
    return 'auto_smart_factory/InitTaskPlannerRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'e6c6ce2b1d8e72cec46147f2b93041a4';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitTaskPlannerRequest(null);
...
class InitTaskPlannerResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitTaskPlannerResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitTaskPlannerResponse
    let len;
    let data = new InitTaskPlannerResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'auto_smart_factory/InitTaskPlannerResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitTaskPlannerResponse(null);
...
module.exports = {
  Request: InitTaskPlannerRequest,
  Response: InitTaskPlannerResponse,
  md5sum() { return '457bcc02d6514ff034af081794e7a4f3'; },
  datatype() { return 'auto_smart_factory/InitTaskPlanner'; }
};
