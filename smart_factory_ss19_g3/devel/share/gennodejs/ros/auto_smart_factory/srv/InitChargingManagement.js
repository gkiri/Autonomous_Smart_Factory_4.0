...
class InitChargingManagementRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitChargingManagementRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitChargingManagementRequest
    let len;
    let data = new InitChargingManagementRequest(null);
  ...
  static datatype() {
    ...
    return 'auto_smart_factory/InitChargingManagementRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitChargingManagementRequest(null);
...
class InitChargingManagementResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InitChargingManagementResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InitChargingManagementResponse
    let len;
    let data = new InitChargingManagementResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'auto_smart_factory/InitChargingManagementResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new InitChargingManagementResponse(null);
...
module.exports = {
  Request: InitChargingManagementRequest,
  Response: InitChargingManagementResponse,
  md5sum() { return 'c4721ba246bdc7ee7d3c229936a53960'; },
  datatype() { return 'auto_smart_factory/InitChargingManagement'; }
};
