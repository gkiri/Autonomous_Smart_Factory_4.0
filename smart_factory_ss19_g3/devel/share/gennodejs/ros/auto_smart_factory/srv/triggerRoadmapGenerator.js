...
class triggerRoadmapGeneratorRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type triggerRoadmapGeneratorRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type triggerRoadmapGeneratorRequest
    let len;
    let data = new triggerRoadmapGeneratorRequest(null);
  ...
  static datatype() {
    ...
    return 'auto_smart_factory/triggerRoadmapGeneratorRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new triggerRoadmapGeneratorRequest(null);
...
class triggerRoadmapGeneratorResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type triggerRoadmapGeneratorResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type triggerRoadmapGeneratorResponse
    let len;
    let data = new triggerRoadmapGeneratorResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'auto_smart_factory/triggerRoadmapGeneratorResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new triggerRoadmapGeneratorResponse(null);
...
module.exports = {
  Request: triggerRoadmapGeneratorRequest,
  Response: triggerRoadmapGeneratorResponse,
  md5sum() { return 'c4721ba246bdc7ee7d3c229936a53960'; },
  datatype() { return 'auto_smart_factory/triggerRoadmapGenerator'; }
};
