...
;//! \htmlinclude InitAgent-request.msg.html

(cl:defclass <InitAgent-request> (roslisp-msg-protocol:ros-message)
...
(cl:defclass InitAgent-request (<InitAgent-request>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <InitAgent-request>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'InitAgent-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auto_smart_factory-srv:<InitAgent-request> is deprecated: use auto_smart_factory-srv:InitAgent-request instead.")))

(cl:ensure-generic-function 'warehouse_configuration-val :lambda-list '(m))
(cl:defmethod warehouse_configuration-val ((m <InitAgent-request>))
...
(cl:defmethod robot_configuration-val ((m <InitAgent-request>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <InitAgent-request>) ostream)
  "Serializes a message object of type '<InitAgent-request>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InitAgent-request>) istream)
  "Deserializes a message object of type '<InitAgent-request>"
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <InitAgent-request>))
  "Converts a ROS message object to a list"
  (cl:list 'InitAgent-request
    (cl:cons ':warehouse_configuration (warehouse_configuration msg))
    (cl:cons ':robot_configuration (robot_configuration msg))
))
;//! \htmlinclude InitAgent-response.msg.html

(cl:defclass <InitAgent-response> (roslisp-msg-protocol:ros-message)
  ((success
    :reader success
    :initarg :success
    :type cl:boolean
...
(cl:defclass InitAgent-response (<InitAgent-response>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <InitAgent-response>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'InitAgent-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name auto_smart_factory-srv:<InitAgent-response> is deprecated: use auto_smart_factory-srv:InitAgent-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <InitAgent-response>))
  ...
  (success m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <InitAgent-response>) ostream)
  "Serializes a message object of type '<InitAgent-response>"
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'success) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <InitAgent-response>) istream)
  "Deserializes a message object of type '<InitAgent-response>"
    (cl:setf (cl:slot-value msg 'success) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<InitAgent-response>)))
  "Returns string type for a service object of type '<InitAgent-response>"
  "auto_smart_factory/InitAgentResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InitAgent-response)))
  "Returns string type for a service object of type 'InitAgent-response"
  "auto_smart_factory/InitAgentResponse")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<InitAgent-response>)))
  "Returns md5sum for a message object of type '<InitAgent-response>"
  "c2878e611fdf9597b4caebc88196ff0d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'InitAgent-response)))
  "Returns md5sum for a message object of type 'InitAgent-response"
  "c2878e611fdf9597b4caebc88196ff0d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<InitAgent-response>)))
  "Returns full string definition for message of type '<InitAgent-response>"
  (cl:format cl:nil "bool success~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'InitAgent-response)))
  "Returns full string definition for message of type 'InitAgent-response"
  (cl:format cl:nil "bool success~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <InitAgent-response>))
  (cl:+ 0
     1
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <InitAgent-response>))
  "Converts a ROS message object to a list"
  (cl:list 'InitAgent-response
    (cl:cons ':success (success msg))
))
(cl:defmethod roslisp-msg-protocol:service-request-type ((msg (cl:eql 'InitAgent)))
  'InitAgent-request)
(cl:defmethod roslisp-msg-protocol:service-response-type ((msg (cl:eql 'InitAgent)))
  'InitAgent-response)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'InitAgent)))
  "Returns string type for a service object of type '<InitAgent>"
  "auto_smart_factory/InitAgent")