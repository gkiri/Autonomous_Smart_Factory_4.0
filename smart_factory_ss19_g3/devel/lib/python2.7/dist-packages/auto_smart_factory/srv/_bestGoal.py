...
"""autogenerated by genpy from auto_smart_factory/bestGoalRequest.msg. Do not edit."""
import sys
...
class bestGoalRequest(genpy.Message):
  _md5sum = "ee056599c9a445b32625c6d835007721"
  _type = "auto_smart_factory/bestGoalRequest"
...
float32 max_load
"""
  __slots__ = ['posStart','idTargets','robot']
  _slot_types = ['geometry_msgs/Point','uint32[]','auto_smart_factory/RobotConfiguration']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.idTargets)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.idTargets))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.idTargets = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(self.idTargets.tostring())
      _x = self.robot.type_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.idTargets = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from auto_smart_factory/bestGoalResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class bestGoalResponse(genpy.Message):
  _md5sum = "ea589563e8b15fe16becce5d8d340f24"
  _type = "auto_smart_factory/bestGoalResponse"
  _has_header = False #flag to mark the presence of a Header object
...
float64 z
"""
  __slots__ = ['resultPoints','idBestTray','length']
  _slot_types = ['geometry_msgs/Point[]','uint32','float64']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       resultPoints,idBestTray,length
    ...
    """
    if args or kwds:
      super(bestGoalResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.resultPoints is None:
        self.resultPoints = []
      if self.idBestTray is None:
        self.idBestTray = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_Id().pack(_x.idBestTray, _x.length))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.idBestTray, _x.length,) = _get_struct_Id().unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
def _get_struct_3d():
    ...
    if _struct_3d is None:
        _struct_3d = struct.Struct("<3d")
    return _struct_3d
class bestGoal(object):
  _type          = 'auto_smart_factory/bestGoal'
  _md5sum = '5663ef057acd0d4321cbcd1579606742'
  _request_class  = bestGoalRequest
  _response_class = bestGoalResponse
