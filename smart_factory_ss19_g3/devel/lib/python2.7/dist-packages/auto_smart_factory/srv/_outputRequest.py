...
"""autogenerated by genpy from auto_smart_factory/outputRequestRequest.msg. Do not edit."""
import sys
...
class outputRequestRequest(genpy.Message):
  _md5sum = "99ea894e2e112745524c8f106fe9556a"
  _type = "auto_smart_factory/outputRequestRequest"
...
float32 max_load
"""
  __slots__ = ['posStart','idTrays','idGoal','robot']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.idGoal)
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(struct.pack(pattern, *self.idGoal))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.idGoal = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sI'%length
      buff.write(self.idGoal.tostring())
      _x = self.robot.type_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.idGoal = numpy.frombuffer(str[start:end], dtype=numpy.uint32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
...
def _get_struct_3d():
    ...
    return _struct_3d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from auto_smart_factory/outputRequestResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class outputRequestResponse(genpy.Message):
  _md5sum = "a02a86b1edfdc92f7484204d045d30c6"
  _type = "auto_smart_factory/outputRequestResponse"
  _has_header = False #flag to mark the presence of a Header object
...
float64 z
"""
  __slots__ = ['pointsToTray','pointsToOutput','idBest','length']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pointsToTray,pointsToOutput,idBest,length
    ...
    """
    if args or kwds:
      super(outputRequestResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.pointsToTray is None:
        self.pointsToTray = []
      if self.pointsToOutput is None:
        self.pointsToOutput = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.pointsToOutput)
      buff.write(_struct_I.pack(length))
      for val1 in self.pointsToOutput:
        _x = val1
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
      _x = self
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
        self.pointsToOutput.append(val1)
      _x = self
      start = end
      end += 12
...
class outputRequest(object):
  _type          = 'auto_smart_factory/outputRequest'
  _md5sum = 'fe895386dfaeb1d8df370061246b0fbb'
  _request_class  = outputRequestRequest
  _response_class = outputRequestResponse
