...
"""autogenerated by genpy from auto_smart_factory/IdlePosition.msg. Do not edit."""
import sys
...
class IdlePosition(genpy.Message):
  _md5sum = "41501a2ca7f33857f2bd60720fb9d76a"
  _type = "auto_smart_factory/IdlePosition"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# unique robot id/name
string id
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(IdlePosition, self).__init__(*args, **kwds)
